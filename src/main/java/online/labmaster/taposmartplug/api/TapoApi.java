...
public interface TapoApi {
    ...
    @RequestMapping(path = "/current-power", method = RequestMethod.GET)
    @Operation(summary = "Operation to obtain data on current power usage.")
    CurrentPowerResponse currentPower(@Parameter(name = "plugIP", description = "Is the ip address of the destination socket on the local network ", in = ParameterIn.QUERY, required = true) @org.springframework.web.bind.annotation.RequestParam String plugIP) throws NoSuchAlgorithmException, IOException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, InvalidAlgorithmParameterException;
